...
public class ExploringHRSystemproject{
    ...
    public static class Main {
        public static void main(String[] args) {
            ...
            SalesRep rep1 = projectInstance.new SalesRep("dhanya", "N", 3037, 22, 200, 5, 35000, 2, 100000);
            SalesManager manager = projectInstance.new SalesManager("varshini", "V", 5059, 22, 100, 50, 50000, 5);

            // Add SalesRep to the team
            manager.addToTeam(rep1);

            // Display information for SalesRep (dhanya)
            System.out.println("dhanya's time to retirement: " + rep1.timeToRetirement());
            System.out.println("dhanya's vacation time left: " + rep1.vacationTimeLeft());
            System.out.println("dhanya's bonus: " + rep1.calculateBonus());
            System.out.println("dhanya's commission: " + rep1.calculateCommission());

            // Display information for SalesManager (varshini)
            System.out.println("varshini's time to retirement: " + manager.timeToRetirement());
            System.out.println("varshini's vacation time left: " + manager.vacationTimeLeft());
            System.out.println("varshini's bonus: " + manager.calculateBonus());
